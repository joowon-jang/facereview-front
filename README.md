...
모든 페이지는 데스크톱·태블릿·모바일 3단계 브레이크포인트로 반응형 대응되어 있습니다.

### 메인 — 감정 데이터 기반 맞춤 추천

<p>
  <img src="./docs/images/main.png" alt="메인 페이지 데스크톱 화면 — 시청 기록과 감정을 분석한 맞춤 추천 영상 목록" width="68%">
  <img src="./docs/images/main-mobile.png" alt="메인 페이지 모바일 화면" width="30%">
</p>

### 시청 — 감정 타임라인 그래프

<p>
  <img src="./docs/images/watch.png" alt="시청 화면 데스크톱 — 영상 위에 겹쳐진 감정 타임라인 그래프와 커스텀 재생 컨트롤" width="68%">
  <img src="./docs/images/watch-mobile.png" alt="시청 화면 모바일" width="30%">
</p>

_다른 시청자들이 구간별로 느낀 감정이 라인 그래프로 영상 위에 표시되고, 그래프를 드래그해 원하는 구간으로 바로 이동할 수 있습니다._

### 마이페이지 — 나의 감정 통계

<p>
  <img src="./docs/images/my.png" alt="마이페이지 데스크톱 — 감정 분포 도넛 차트와 최근 시청 영상별 감정 그래프" width="68%">
  <img src="./docs/images/my-mobile.png" alt="마이페이지 모바일" width="30%">
</p>

_최근 본 영상마다 시청 중 느낀 감정 그래프가 함께 표시되고, 전체 시청 시간의 감정 분포를 도넛 차트로 보여줍니다._
...
| 2026.01 ~ 2026.04 | 1차 리팩토링 — 개선 방향·신규 기능 기획과 디자인 회의, 일부 구현 |
| 2026.07 | 2차 리팩토링 — 기획된 개선 사항 구현에 집중 |
